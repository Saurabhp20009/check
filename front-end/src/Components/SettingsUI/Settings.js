...
const Settings = () => {
  ...
  const getUserInfo = async () => {
    await axios
      .post(
        "https://backend.connectsyncdata.com:5000/user/api/gettinguser",
        {
          email: user.email,
        },
        {
  ...
  const handleAweberButton = async () => {
    await axios
      .get("https://backend.connectsyncdata.com:5000/aweber/api/buildauthurl", {
        headers: headers,
      })
      .then((response) => {
  ...
  const handleGoogleLink = async () => {
    console.log(headers);
    await axios
      .get(`https://backend.connectsyncdata.com:5000/goauth/api/link?email=${user.email}`, {
        headers: headers,
      })
      .then((response) => {
  ...
  const handleUnlinkGTWAccount = async () => {
    await axios
      .delete(
        `https://backend.connectsyncdata.com:5000/gotowebinar/api/remove/account?email=${user.email}`,
        {
          headers: headers,
        }
      )
  ...
  const handleUnlinkGoogleAccount = async () => {
    await axios
      .delete(
        `https://backend.connectsyncdata.com:5000/goauth/api/unlink/googleaccount?email=${user.email}`,
        {
          headers: headers,
        }
      )
  ...
  const handleBrevoAccountRemove = async () => {
    await axios
      .delete(
        `https://backend.connectsyncdata.com:5000/brevo/api/delete/account?email=${user.email}`,
        {
          headers: headers,
        }
      )
  ...
  const handleRemoveGetResponseAccount = async () => {
    const r = await axios
      .delete(
        `https://backend.connectsyncdata.com:5000/getresponse/api/remove/account?id=${displayLinked.GetResponse._id}`,
        {
          headers: headers,
        }
      )
  ...
  const handleAweberRemove = async () => {
    const r = await axios
      .delete(
        `https://backend.connectsyncdata.com:5000/aweber/api/remove/account?id=${displayLinked.Aweber._id}`,
        {
          headers: headers,
        }
      )
  ...
  const handleBigmarkerAccountRemove = async () => {
    const r = await axios
      .delete(
        `https://backend.connectsyncdata.com:5000/bigmarker/api/remove/account?id=${displayLinked.Bigmarker._id}`,
        {
          headers: headers,
        }
      )
  ...
  const handleSendyAccountRemove = async () => {
    const r = await axios
      .delete(
        `https://backend.connectsyncdata.com:5000/sendy/api/remove/account?id=${displayLinked.Sendy._id}`,
        {
          headers: headers,
        }
      )
  ...
  const handleActiveCampaignDisconnect=async()=>{
    const r = await axios
    .delete(
      `https://backend.connectsyncdata.com:5000/active/api/unlink/active/account?id=${displayLinked.ActiveCampaign._id}`,
      {
        headers: headers,
      }
    )
