...
function BigmarkerAutomationCard({
  ...
  const handleStartAutomation = async () => {
    ...
    if (operation === "2") {
      ...
      await axios
        .post(
          `http://24.199.76.74:5000/bigmarker/api/start/bigmarkertosheet/automation?email=${user.email}`,
          body,
          {
            headers: headers,
          }
      ...
      await axios
        .post(
          `http://24.199.76.74:5000/bigmarker/api/start/automation?email=${user.email}`,
          body,
          {
            headers: headers,
          }
      ...
      await axios
        .post(
          `http://24.199.76.74:5000/bigmarker/api/start/bigmarkertoapp/automation?email=${user.email}`,
          body,
          {
            headers: headers,
          }
      ...
      await axios
        .post(
          `http://24.199.76.74:5000/bigmarker/api/start/del/automation?email=${user.email}`,
          body,
          {
            headers: headers,
          }
