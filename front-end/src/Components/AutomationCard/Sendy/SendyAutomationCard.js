...
function SendyAutomationCard({ setShowAutomationCard, ShowAutomationCard }) {
  ...
  const handleStartAutomation = async () => {
    ...
    if (operation == 1) {
      await axios
        .post(
          `http://backend.connectsyncdata.com:5000/sendy/api/start/automation?email=${user.email}`,
          body,
          {
            headers: headers,
          }
      ...
      await axios
        .post(
          `http://backend.connectsyncdata.com:5000/sendy/api/start/del/automation?email=${user.email}`,
          body,
          {
            headers: headers,
          }
