...
function GTWAutomationCard({ setShowAutomationCard, ShowAutomationCard }) {
  ...
  const handleStartAutomation = async () => {
    ...
    if (operation == 2) {
      await axios
        .post(
          `http://connectsyndata.com:5000/gotowebinar/api/start/gtwtosheet/automation?email=${user.email}`,
          body,
          {
            headers: headers,
          }
      ...
      await axios
        .post(
          `http://connectsyndata.com:5000/gotowebinar/api/start/automation?email=${user.email}`,
          body,
          {
            headers: headers,
          }
      ...
      await axios
        .post(
          `http://connectsyndata.com:5000/gotowebinar/api/start/gtwtoapp/automation?email=${user.email}`,
          body,
          {
            headers: headers,
          }
      ...
      await axios
        .post(
          `http://connectsyndata.com:5000/gotowebinar/api/start/del/automation?email=${user.email}`,
          body,
          {
            headers: headers,
          }
