  ...
  try {
    ...
    if (Operation == 1) {
      ...
      const response = await axios
        .post(
          `https://backend.connectsyncdata.com:5000/brevo/api/start/automation?email=${email}`,
          body,
          {
            headers: headers,
          }
      ...
      const response = await axios
        .post(
          `https://backend.connectsyncdata.com:5000/brevo/api/start/del/automation?email=${email}`,
          body,
          {
            headers: headers,
          }
