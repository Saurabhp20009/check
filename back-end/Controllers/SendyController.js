  ...
  try {
    ...
    if (Operation == 1) {
      ...
      const response = await axios
        .post(
          `http://backend.connectsyncdata.com:5000/sendy/api/start/automation?email=${email}`,
          body,
          {
            headers: headers,
          }
      ...
      const response = await axios
        .post(
          `http://backend.connectsyncdata.com:5000/sendy/api/start/del/automation?email=${email}`,
          body,
          {
            headers: headers,
          }
