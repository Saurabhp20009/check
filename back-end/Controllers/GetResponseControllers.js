  ...
  try {
    ...
    if (Operation == 1) {
      const response = await axios
        .post(
          `http://connectsyndata.com:5000/getresponse/api/start/automation?email=${email}`,
          body,
          {
            headers: headers,
          }
      ...
      const response = await axios
        .post(
          `http://connectsyndata.com:5000/getresponse/api/start/del/automation?email=${email}`,
          body,
          {
            headers: headers,
          }
