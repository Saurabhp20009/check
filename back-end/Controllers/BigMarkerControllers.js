  ...
  try {
    ...
    if (Operation == 1) {
      ...
      const response = await axios
        .post(
          `http://24.199.76.74:5000/bigmarker/api/start/automation?email=${email}`,
          body,
          {
            headers: headers,
          }
      ...
      await axios
        .post(
          `http://24.199.76.74:5000/bigmarker/api/start/bigmarkertosheet/automation?email=${email}`,
          body,
          {
            headers: headers,
          }
      ...
      await axios
        .post(
          `http://24.199.76.74:5000/bigmarker/api/start/bigmarkertoapp/automation?email=${email}`,
          body,
          {
            headers: headers,
          }
      ...
      const response = await axios
        .post(
          `http://24.199.76.74:5000/bigmarker/api/start/del/automation?email=${email}`,
          body,
          {
            headers: headers,
          }
