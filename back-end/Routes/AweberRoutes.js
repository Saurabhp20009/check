...
const { buildAuthUrlAweber, createTokenAweberAndStoreInDB, checkAweberLink, gettingAweberLists, revokeToken, startAutomation, gettingSpreadSheetsList, gettingSheetsList, restartAutomation, getAllWorkflows, handleRemove, handleEditAutomation, handleDeleteSubscribers, StartAutomationAweberToApp,  } = require('../Controllers/AweberControllers')
...
aweberRouter.post("/start/aweber/app/automation/",verifyToken,StartAutomationAweberToApp)
